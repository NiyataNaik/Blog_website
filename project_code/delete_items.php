...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="add_post.php" class="list-group-item ">add_post</a>
        <a href="edit_food_items.php" class="list-group-item ">Edit Blog</a>
    		<a href="delete_items.php" class="list-group-item active">Delete post</a>
    	</div>
    </div>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;">Choose your post to delete</h3>
